...
def download_sam_model():
    ...
    try:
        ...
        def show_progress(block_num, block_size, total_size):
            ...
            print(
                f"\r   Progress: |{bar}| {percentage:.1f}% ({downloaded // 1024 // 1024}MB/{total_size // 1024 // 1024}MB)",
                end="",
            )
...
def test_budget_detector():
    ...
    try:
        ...
        print(
            f"✅ Kelp probability mask generated: {kelp_pixels} potential kelp pixels"
        )
...
def print_next_steps():
    ...
    print("💡 Quick start:")
    print(
        "   from src.kelpie_carbon.deep_learning.budget_sam_detector import BudgetSAMKelpDetector"
    )
