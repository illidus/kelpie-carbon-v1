...
class TestValidationCLI:
    ...
    def test_load_validation_config_failure(self):
        ...
        with patch(
            "kelpie_carbon.validation.cli.load", side_effect=Exception("Config error")
        ):
            config = load_validation_config()
    ...
    def test_cli_validate_command_missing_dataset(self):
        ...
        result = self.runner.invoke(
            app, ["validate", "--dataset", "nonexistent.json", "--out", "test_output"]
        )
    ...
    def test_cli_config_command(self):
        ...
        with patch(
            "kelpie_carbon.validation.cli.load_validation_config",
    ...
    def test_cli_config_command_no_config(self):
        ...
        with patch(
            "kelpie_carbon.validation.cli.load_validation_config", return_value={}
        ):
            result = self.runner.invoke(app, ["config"])
    ...
    def test_metric_helpers_integration(self):
        ...
        dice = helpers.calculate_dice_coefficient(
...
class TestValidationCLIEdgeCases:
    ...
    def test_report_generation_error_handling(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            validation_result = ValidationResult(
                campaign_id="test", test_site="test", model_name="test"
            )
