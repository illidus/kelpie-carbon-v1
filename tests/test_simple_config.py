...
from kelpie_carbon_v1.config.simple import SimpleConfig, get_simple_config, get_config_for_environment
...
class TestSimpleConfig:
    ...
    def test_cloud_cover_validation(self):
        ...
        with pytest.raises(ValueError, match="Max cloud cover must be between 0.0 and 1.0"):
            config.__post_init__()
