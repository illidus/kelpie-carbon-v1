...
class ProfessionalReportGenerator:
    ...
    def generate_html_report(self, 
        ...
        """
        template_class = self.templates.get(config.report_type, ProfessionalReportTemplate)
    ...
    def generate_stakeholder_reports(self, 
        ...
        for stakeholder_type, config_updates in stakeholder_configs.items():
            ...
            stakeholder_config = ReportConfiguration(
                ...
                vera_compliance=config_updates.get('vera_compliance', base_config.vera_compliance),
                include_mathematical_details=config_updates['include_mathematical_details'],
                include_uncertainty_analysis=config_updates['include_uncertainty_analysis'],
                logo_path=base_config.logo_path,
                custom_css=base_config.custom_css
            )
            
            # Generate HTML report
            html_path = Path(output_dir) / f"{base_config.site_name}_{stakeholder_type}_report_{base_config.analysis_date}.html"
