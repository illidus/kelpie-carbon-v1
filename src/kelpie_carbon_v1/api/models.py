...
class SpectralIndicesModel(BaseModel):
    ...
    avg_ndre: Optional[StrictFloat] = Field(
    ...
    avg_red_edge_ndvi: Optional[StrictFloat] = Field(
        None, description="Average Red Edge NDVI value"
    )
    avg_kelp_index: Optional[StrictFloat] = Field(
        None, description="Average Kelp Index value"
    )
    std_ndvi: Optional[StrictFloat] = Field(
        None, description="Standard deviation of NDVI"
    )
    std_ndre: Optional[StrictFloat] = Field(
        None, description="Standard deviation of NDRE"
    )
    std_fai: Optional[StrictFloat] = Field(
