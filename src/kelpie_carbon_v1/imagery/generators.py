...
from .utils import normalize_band, normalize_to_0_1, apply_colormap, array_to_image


def generate_rgb_composite(
    dataset: xr.Dataset, 
    red_band: str = 'red',
    green_band: Optional[str] = None,
...
def generate_comparative_ndvi_ndre_visualization(dataset: xr.Dataset) -> Image.Image:
    ...
    # Add colorbar
    plt.colorbar(im2, ax=[ax1, ax2], orientation='horizontal', 
                 pad=0.1, label='Vegetation Index Value')
