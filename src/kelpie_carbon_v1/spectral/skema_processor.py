...
from ..core.indices import calculate_indices_from_dataset
...
class SKEMAProcessor:
    ...
    def calculate_spectral_indices(self, 
                                 ...
                                 red_edge_array: Optional[np.ndarray] = None) -> Dict[str, np.ndarray]:
        """
    ...
    def get_kelp_probability_mask(self,
                                rgb_array: np.ndarray,
                                nir_array: Optional[np.ndarray] = None,
                                red_edge_array: Optional[np.ndarray] = None) -> np.ndarray:
        """
    ...
    def validate_input_bands(self, 
                           rgb_array: np.ndarray,
                           nir_array: Optional[np.ndarray] = None,
                           red_edge_array: Optional[np.ndarray] = None) -> Dict[str, bool]:
        """
