...
class SpeciesClassificationResult:
    ...
    biomass_estimate_kg_per_m2: Optional[float] = None
    biomass_estimate_enhanced: Optional[BiomassEstimate] = None
    ...
    def classify_species(
        ...
        try:
            ...
            return SpeciesClassificationResult(
                ...
                confidence=0.0,
                species_probabilities={species: 0.0 for species in KelpSpecies},
