...
class ValidationDataManager:
    ...
    def add_ground_truth(self, measurement: GroundTruthMeasurement) -> str:
        ...
        with sqlite3.connect(self.db_path) as conn:
            ...
            """, (
                ...
                json.dumps(measurement.spectral_data) if measurement.spectral_data else None
            ))
    ...
    def get_ground_truth_for_campaign(self, campaign_id: str) -> List[GroundTruthMeasurement]:
        ...
        with sqlite3.connect(self.db_path) as conn:
            ...
            for row in cursor.fetchall():
                ...
                measurements.append(GroundTruthMeasurement(
