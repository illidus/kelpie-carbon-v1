...
def validate(
    ...
    if validation_result.passed_validation:
        console.print(f"[green]✅ Validation PASSED[/green] - Results saved to {output}")
    else:
        console.print(f"[red]❌ Validation FAILED[/red] - Check reports for details")
        for error in validation_result.validation_errors:
