...
class RealDataAcquisition:
    ...
    def get_validation_sites(self, region: str | None = None, species: str | None = None) -> list[ValidationSite]:
        """
    ...
    def save_validation_dataset(self, dataset: ValidationDataset, filename: str | None = None) -> str:
        """
    ...
    def create_benchmark_suite(self, include_sites: list[str] | None = None) -> dict[str, ValidationDataset]:
        """
...
def create_real_data_acquisition(data_directory: str | None = None) -> RealDataAcquisition:
    """
...
def get_validation_sites(region: str | None = None, species: str | None = None) -> list[ValidationSite]:
