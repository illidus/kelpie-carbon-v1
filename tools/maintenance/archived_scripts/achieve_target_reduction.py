...
class TargetReducer:
    def __init__(self):
        ...
        self.target_final = int(
            self.original_baseline * 0.5
        )  # 50% reduction = 725 tests
        self.removed_files = []
    ...
    def remove_backup_directories(self):
        ...
        backup_dirs = ["tests_backup", "tests_backup_20250611_164341"]
    ...
    def fix_import_errors(self):
        ...
        error_files = [Path("tests/unit/test_validation_plots.py")]
    ...
    def remove_files_to_target(self, current_count):
        ...
        if current_count <= self.target_final:
            print(
                f"Already at target! Current: {current_count}, Target: {self.target_final}"
            )
            return 0
        ...
        for test_file, test_count in test_files:
            ...
            # Skip critical files
            if any(
                critical in str(test_file)
                for critical in ["conftest", "__init__", "e2e", "common"]
            ):
                continue
